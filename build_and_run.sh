...
i686-elf-gcc -T linker.ld -o output/myos.bin -ffreestanding -O2 -nostdlib output/descriptor_tables.o output/io.o output/debug.o output/terminal.o output/utils.o output/boot.o output/gdt.o output/kernel.o -lgcc;
