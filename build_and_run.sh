...
i686-elf-as interrupt_asm.s -o output/interrupt_asm.o;
...
i686-elf-gcc -c asm.c  -o output/asm.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra;
...
i686-elf-gcc -T linker.ld -o output/myos.bin -ffreestanding -O2 -nostdlib output/notepad.o output/keyboard.o output/interrupts.o output/descriptor_tables.o output/asm.o output/debug.o output/terminal.o output/utils.o output/boot.o output/interrupt_asm.o output/gdt.o output/kernel.o -lgcc;
